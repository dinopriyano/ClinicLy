 ...
 * @author dinop
 */
@WebServlet(name = "Pendaftaran", urlPatterns = {"/Pendaftaran"})
public class PendaftaranController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Gson g=new Gson();
        if(page==null){
            List<PendaftaranModel> list=dao.getAllPendaftaran();
